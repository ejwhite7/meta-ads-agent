...
export function Configuration(): React.ReactElement {
	 ...
	 */
	function updateField<K extends keyof ConfigFormState>(key: K, value: ConfigFormState[K]): void {
		...
		<div className="space-y-6 max-w-2xl">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
					<div>
						...
						<input
							...
							onChange={(e) => updateField("roasTarget", Number.parseFloat(e.target.value))}
							className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
						/>
					</div>
					<div>
						<label
							htmlFor="config-field-2"
							className="block text-sm font-medium text-gray-700 mb-1"
						>
							CPA Cap ($)
						</label>
						<input
							...
							min="0"
							value={config.cpaCap}
							onChange={(e) => updateField("cpaCap", Number.parseFloat(e.target.value))}
							className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
						/>
					</div>
					<div>
						<label
							htmlFor="config-field-3"
							className="block text-sm font-medium text-gray-700 mb-1"
						>
							Daily Budget Limit ($)
						</label>
						<input
							...
							onChange={(e) => updateField("dailyBudgetLimit", Number.parseFloat(e.target.value))}
							className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
						/>
					</div>
					<div>
						<label
							htmlFor="config-field-4"
							className="block text-sm font-medium text-gray-700 mb-1"
						>
							Risk Level
						</label>
			...
			<section className="bg-white rounded-lg border border-gray-200 p-6">
				...
				<div className="flex gap-4">
					<label htmlFor="config-field-5" className="flex items-center gap-2 cursor-pointer">
						<input
							id="config-field-5"
							type="radio"
							name="llmProvider"
					...
					<label htmlFor="config-field-6" className="flex items-center gap-2 cursor-pointer">
						<input
							id="config-field-6"
							type="radio"
							name="llmProvider"
			...
			<section className="bg-white rounded-lg border border-gray-200 p-6">
				...
				<select
					...
					onChange={(e) => updateField("tickIntervalMinutes", Number.parseInt(e.target.value, 10))}
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
					<div>
						...
						<input
							...
							onChange={(e) => updateField("minBudget", Number.parseFloat(e.target.value))}
							className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
						/>
					</div>
					<div>
						<label
							htmlFor="config-field-8"
							className="block text-sm font-medium text-gray-700 mb-1"
						>
							Max Scale Factor
						</label>
						<input
							...
							onChange={(e) => updateField("maxScaleFactor", Number.parseFloat(e.target.value))}
							className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
						/>
					</div>
					<div className="sm:col-span-2">
						<label
							htmlFor="config-field-9"
							className="block text-sm font-medium text-gray-700 mb-1"
						>
						...
						<input
							...
							onChange={(e) =>
								updateField("requireApprovalThreshold", Number.parseFloat(e.target.value))
							}
							className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
						/>
