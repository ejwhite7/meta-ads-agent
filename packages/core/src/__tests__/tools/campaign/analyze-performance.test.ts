...
import type { Campaign, CampaignInsights, ToolContext } from "../../../tools/types.js";
...
function campaignWithInsights(insightsOverrides: Partial<CampaignInsights> = {}): Campaign {
	return {
		id: "camp_001",
