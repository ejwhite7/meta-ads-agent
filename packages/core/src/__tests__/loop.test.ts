...
describe('runAgentLoop', () => {
  ...
  it('should limit proposals to maxProposals', async () => {
    ...
    const llmResponse = JSON.stringify([
      { toolName: 'tool_a', params: { id: '1' }, reasoning: 'r1', expectedOutcome: 'o1', confidence: 0.9, expectedImpact: 0.9, riskLevel: 'low' },
      { toolName: 'tool_b', params: { id: '2' }, reasoning: 'r2', expectedOutcome: 'o2', confidence: 0.8, expectedImpact: 0.8, riskLevel: 'low' },
      { toolName: 'tool_a', params: { id: '3' }, reasoning: 'r3', expectedOutcome: 'o3', confidence: 0.7, expectedImpact: 0.7, riskLevel: 'low' },
    ]);
